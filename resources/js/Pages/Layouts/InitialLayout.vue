    ...
    <div class="max-w-7xl mx-auto px-2 sm:px-6 lg:px-8">
      <div class="relative flex items-center justify-between h-16">
        ...
        <div class="flex-1 flex items-center justify-center sm:items-stretch sm:justify-start">
          <Link class="flex-shrink-0 flex items-center" :href="route('home')">
        ...
        <div class="flex items-center justify-center">
            <comp-dropdown align="right" width="" contentClasses="py-1 bg-white dark:bg-gray-700">
                <template #trigger>
                    <span class="inline-flex rounded-md">
                        <button type="button" class="color-text inline-flex items-center px-3 py-2 border border-transparent text-sm leading-4 font-medium rounded-md focus:outline-none transition">
...
<style >
    .color-text {
        @apply text-gray-500 bg-white hover:text-gray-700;
        @apply dark:text-white dark:bg-gray-700 dark:hover:text-gray-500;
    }
</style>
